...
| 学习记录 | Chapter 01—46 已 Closed；Episode 06/07/09 Closed，Episode 08/10 Open | Qwen3-VL 继续 whole-loop workspace reuse、长生成与 BF16 strict oracle；Episode 08 保留跨 adapter action safety 缺口；保持 oracle/因果对照/replay 门禁 |
