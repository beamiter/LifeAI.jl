...
[`Week 09 — Qwen3 Sampling Fidelity and Real Inference Performance`](week09_qwen3_sampling_performance.md) 已于 2026-07-23 Closed，Week 01—09 当前全部关闭，尚未 Open Week 10。近期核心目标仍是持续复现经典/SOTA 模型与论文；下一阶段可从 native BF16/量化、Qwen3 MoE 或另一类经典架构中选择，但还没有把任一路线写成已承诺的 Week。
...
| 主线 | 当前状态 | 下一关键缺口 |
| --- | --- | --- |
| 模型基本组件 | Qwen3 dense 同构结构；HF config / safetensors / tokenizer；Qwen3-0.6B greedy/sampled text→text parity；40,959 RoPE reference；四类版本化 Tokenizer 与中文数据管线 | 选择 native BF16、MoE 或下一经典模型 |
...
| 学习记录 | Week 01—09 已 Closed | 以论文/官方 reference、数值 parity、性能原始记录为近期节奏，选择 Week 10 主题 |
