...
- **进入下一章的问题**：剩余约 `288 MB` allocation 由 task/bookkeeping、路由还是小数组各占多少；继续优化 allocator traffic 与补齐 grouped scattered dispatch，哪一个对真实 workload 价值更高。
