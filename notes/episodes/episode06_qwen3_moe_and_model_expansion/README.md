...
- **训练与推理**：Float32 correctness oracle、CPU sparse dispatch、compact Reactant/XLA CPU 与低 workspace CUDA indexed kernels 已完成；下一步推进 grouped GEMM 与真实 checkpoint cache decode。
