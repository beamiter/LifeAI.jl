...
- **进入下一章的问题**：能否在 H2D 完成的明确同步边界后按 pipeline slot 复用最终 host projection matrices，再削减当前约 `28.967 GB` 分配，同时严格保持 pageable/pinned upload ownership。
