# Chapter 02 — Minimal GPT, XLA Training, and KV-Cached Decoding

> 状态：Closed
>
> Chapter 代表逻辑研发阶段而非自然周；达到 Close 条件后即可进入下一阶段。

## 本阶段目标

Chapter 01 已经完成 Attention、RoPE 和 TransformerBlock，本阶段的核心问题是：
...
到这里，Chapter 01 提出的“最小完整 GPT”目标已经形成端到端闭环；不过当前验证重点是闭环正确性与 loss 下降，还不是模型质量或规模能力。
