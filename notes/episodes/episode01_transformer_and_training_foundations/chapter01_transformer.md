# Chapter 01 — Project Skeleton and Transformer Foundations

> 状态：Closed
>
> 历史记录：Chapter 代表逻辑研发阶段而非自然周。本文保留 Chapter 01 当时的目标与 TODO；后续多项 TODO 已经完成，最新状态请查看 [`../../current_status.md`](../../current_status.md)。
